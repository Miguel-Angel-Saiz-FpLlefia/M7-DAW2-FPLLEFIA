...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Estilos del Acordeón (Usando <details> y <summary>) */
        .faq-item {
            background: white;
            border-radius: 12px;
            margin-bottom: 1rem;
        ...
        .faq-question::after {
            content: "\f054"; /* Código Font Awesome para chevron-right */
        ...
        .faq-item[open] .faq-question::after {
            transform: rotate(90deg); /* Rota la flecha cuando está abierto */
        }
...
<body>
    ...
    <section class="faqs-hero">
        <div class="section-header" style="margin-bottom: 0;">
            ...
            <p>Encuentra respuestas rápidas a las dudas más comunes sobre la compra de entradas.</p>
        </div>
    </section>
